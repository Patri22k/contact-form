...
const RadioSelected = ({ selectedRadio, setSelectedRadio, radioError, setRadioError }) => {
    ...
    return (
        <div className='radio-div flex gap-3'>
            <div 
                className="radio1 border-2 rounded-md flex items-center px-5 hover:border-[#0C7D69]"
                style={{ 
            ...
            <div 
                className="radio2 border-2 rounded-md flex items-center px-5 hover:border-[#0C7D69]"
                style={{
